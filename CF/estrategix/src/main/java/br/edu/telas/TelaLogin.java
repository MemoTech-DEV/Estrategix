...
public class TelaLogin extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jButton1.setForeground(new java.awt.Color(255, 189, 89));
        ...
        jButton2.setForeground(new java.awt.Color(255, 189, 89));
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(userText, javax.swing.GroupLayout.PREFERRED_SIZE, 329, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        .addGap(50, 50, 50)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        if ((userText.getText().equals("ESTRATEGIX")) && (new String(senhaText.getPassword()).equals("213344"))) {
            JOptionPane.showMessageDialog(null, "Logado com sucesso!");
            TelaInicial tela = new TelaInicial();
            tela.setVisible(true);
            dispose();
        }else{
            JOptionPane.showMessageDialog(null, "Senha ou usuário incorreto,limpe e tente novamente!");
        }
